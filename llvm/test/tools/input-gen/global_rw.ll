...
; RUN: %S/run_all.sh %T
; ModuleID = 'global_rw.c'
source_filename = "global_rw.c"
...
define dso_local i32 @global_read() local_unnamed_addr #0 {
entry:
...
define dso_local void @global_write() local_unnamed_addr #1 {
entry:
  store i32 42, ptr @G, align 4, !tbaa !5
  ret void
}
